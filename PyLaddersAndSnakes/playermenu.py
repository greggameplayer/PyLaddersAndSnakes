...
class PLAYERMENU:
    def __init__(self, playerNumber, pypresence):
        ...
        if self.playerNumber == 1:
            ...
            self.color1 = Button(
                self.menu, background="blue", width=5, activebackground="blue"
            )
            ...
            self.color2 = Button(
                self.menu, background="red", width=5, activebackground="red"
            )
            ...
            self.color3 = Button(
                self.menu, background="green", width=5, activebackground="green"
            )
            ...
            self.color4 = Button(
                self.menu, background="yellow", width=5, activebackground="yellow"
            )
        ...
        if (
            ...
            if (
                ...
                if (
                    self.playerNumber == 1
                    or self.playerNumber == 2
                    and self.color1["background"] != self.color2["background"]
                    or self.playerNumber == 3
                    and self.color1["background"] != self.color2["background"]
                    and self.color3["background"] != self.color2["background"]
                    and self.color1["background"] != self.color3["background"]
                    or self.playerNumber == 4
                    and self.color1["background"] != self.color2["background"]
                    and self.color3["background"] != self.color2["background"]
                    and self.color1["background"] != self.color3["background"]
                    and self.color1["background"] != self.color4["background"]
                    and self.color2["background"] != self.color4["background"]
                    and self.color3["background"] != self.color4["background"]
                ):
                    ...
                    game = MAINGAME(
                        self.playerNumber, PlayerNames, PlayerColors, self.pypresenceRPC
                    )
                else:
                    tkmessage.showerror(
                ...
                tkmessage.showerror(
                    "Erreur de nom de joueur", "Veuillez choisir des noms de joueurs !"
                )
        else:
            tkmessage.showerror(
