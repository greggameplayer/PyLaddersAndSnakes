...
class PLAYERMENU:
    def __init__(self, playerNumber, pypresence):
        ...
        if self.playerNumber == 1:
            self.label1 = Label(self.menu,
                                text="Joueur 1 : ",
                                background="lightblue")
            self.label1.grid(row=0, column=3, pady=20)
            self.entree1 = Entry(self.menu,
                                 textvariable=self.varInput,
                                 width=30)
            self.entree1.grid(row=0, column=4)
            self.color1 = Button(self.menu,
                                 background="blue",
                                 width=5,
            ...
            self.color1 = Button(self.menu,
                                 ...
                                 activebackground="blue")
            self.color1.grid(row=0, column=5)
            self.label2 = Label(self.menu,
                                text="Joueur 2 : ",
                                background="lightblue")
            self.label2.grid(row=1, column=3)
            self.entree2 = Entry(self.menu,
                                 textvariable=self.varInput2,
                                 width=30)
            self.entree2.grid(row=1, column=4, pady=20)
            self.color2 = Button(self.menu,
                                 background="red",
                                 width=5,
            ...
            self.color2 = Button(self.menu,
                                 ...
                                 activebackground="red")
            self.color2.grid(row=1, column=5)
            self.label3 = Label(self.menu,
                                text="Joueur 3 : ",
                                background="lightblue")
            self.label3.grid(row=2, column=3, pady=20)
            self.entree3 = Entry(self.menu,
                                 textvariable=self.varInput3,
                                 width=30)
            self.entree3.grid(row=2, column=4)
            self.color3 = Button(self.menu,
                                 background="green",
                                 width=5,
            ...
            self.color3 = Button(self.menu,
                                 ...
                                 activebackground="green")
            self.color3.grid(row=2, column=5)
            self.label4 = Label(self.menu,
                                text="Joueur 4 : ",
                                background="lightblue")
            self.label4.grid(row=3, column=3, pady=20)
            self.entree4 = Entry(self.menu,
                                 textvariable=self.varInput4,
                                 width=30)
            self.entree4.grid(row=3, column=4)
            self.color4 = Button(self.menu,
                                 background="yellow",
                                 width=5,
    ...
    def onBtClick(self, _event):
        ...
        if (self.playerNumber == 1 or self.playerNumber == 2
                ...
                and self.varInput.get() != self.varInput2.get()
                and self.varInput.get() != self.varInput3.get()
                and self.varInput2.get() != self.varInput3.get()
                or self.playerNumber == 4
                and self.varInput.get() != self.varInput2.get()
                and self.varInput.get() != self.varInput3.get()
                and self.varInput2.get() != self.varInput3.get()
                and self.varInput.get() != self.varInput4.get()
                and self.varInput2.get() != self.varInput4.get()
                and self.varInput4.get() != self.varInput3.get()):

            if (self.playerNumber == 1
                    and "".join(self.varInput.get().split(" ")) != ""
                    or self.playerNumber == 2
                    and "".join(self.varInput.get().split(" ")) != ""
                    and "".join(self.varInput2.get().split(" ")) != ""
                    or self.playerNumber == 3
                    and "".join(self.varInput.get().split(" ")) != ""
                    and "".join(self.varInput2.get().split(" ")) != ""
                    and "".join(self.varInput3.get().split(" ")) != ""
                    or self.playerNumber == 4
                    and "".join(self.varInput.get().split(" ")) != ""
                    and "".join(self.varInput2.get().split(" ")) != ""
                    and "".join(self.varInput3.get().split(" ")) != ""
                    and "".join(self.varInput4.get().split(" ")) != ""):

                if (self.playerNumber == 1 or self.playerNumber == 2 and
                        self.color1["background"] != self.color2["background"]
                        or self.playerNumber == 3 and self.color1["background"]
                        != self.color2["background"] and
                        self.color3["background"] != self.color2["background"]
                        and
                        self.color1["background"] != self.color3["background"]
                        or self.playerNumber == 4 and
                        self.color1["background"] != self.color2["background"]
                        and self.color3["background"] !=
                        self.color2["background"] and self.color1["background"]
                        != self.color3["background"] and
                        self.color1["background"] != self.color4["background"]
                        and self.color2["background"] !=
                        self.color4["background"] and self.color3["background"]
                        != self.color4["background"]):
